...
export const AgentOutput = () => (
  <OttieBubble type="agent-output" body="周五晚上有空一起吃个饭吗？" time="14:30" status="sent" />
)

export const AgentOutputRead = () => (
  <OttieBubble type="agent-output" body="好的，周五见！" time="14:32" status="read" />
)
...
export const UserIntent = () => (
  <OttieBubble type="user-intent" body="帮我问他周五去不去吃饭，语气随意一点" time="14:28" />
)
